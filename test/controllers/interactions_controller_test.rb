...
class InteractionsControllerTest < ActionController::TestCase
  ...
  test "should create interaction" do
    assert_difference('Interaction.count') do
      post :create, interaction: { mensaje: @interaction.mensaje, pregunta: @interaction.pregunta, product_id: @interaction.product_id, user_id: @interaction.user_id }
    end
  ...
  test "should update interaction" do
    patch :update, id: @interaction, interaction: { mensaje: @interaction.mensaje, pregunta: @interaction.pregunta, product_id: @interaction.product_id, user_id: @interaction.user_id }
    assert_redirected_to interaction_path(assigns(:interaction))
  end
